...
If Python is not available, download the latest Windows binary ZIP from the [releases](https://github.com/genotrance/px/releases)
...
On Linux, the Gnome Keyring or KWallet can be used to store passwords.
